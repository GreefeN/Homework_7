...
namespace Homework_7
{
    ...
    class Program
    {
        ...
        {
            string path = @"D:\file.txt"; //путь к файлу ежедневника
            FileDiary fDiary = new FileDiary(path); //работа с файлом ежедневника
            Diary d = fDiary.diary; //работа с записями ежедневника
            d.DiaryMenu(fDiary); //основное меню ежедневника
            Console.ReadKey();
        }
    }
}
